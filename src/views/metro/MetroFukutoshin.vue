<template>
  <div class="line-info">
    ...
    <div class="line-details">
      ...
      <p>起點站：和光市站</p>
      <p>終點站：渋谷站</p>
      <p>特色：連接池袋、新宿、渋谷等副都心地區</p>
      <p>主要站點：池袋、新宿三丁目、明治神宮前、渋谷</p>
      <p>直通運轉：東武東上線、西武有楽町線、東急東横線、横浜高速みなとみらい線</p>
    </div>
  </div>
</template>
...
export default {
  name: 'MetroFukutoshin',
  setup() {
    const hasDelay = ref(false);
    const delayInfo = ref(null);
    const delayChecker = createDelayChecker('東京メトロ', ['副都心線']);
...
h2 {
  color: #333;
  border-bottom: 2px solid #9C5E31;
  padding-bottom: 10px;
}
